    ...
    <footer className="bg-black text-white py-12 border-t border-red-500">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-red-400 text-sm">Votre Partenaire Immobilier</p>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              Découvrez l'incarnation de la flexibilité et donnez du pouvoir à vos projets immobiliers avec notre solution complète.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-red-400 transition-colors">Propriétés</a></li>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-red-500">Types de Propriétés</h4>
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-red-400 transition-colors">Maisons de Luxe</a></li>
              <li><a href="#" className="hover:text-red-400 transition-colors">Appartements</a></li>
              <li><a href="#" className="hover:text-red-400 transition-colors">Commercial</a></li>
              <li><a href="#" className="hover:text-red-400 transition-colors">Propriétés d'Investissement</a></li>
              <li><a href="#" className="hover:text-red-400 transition-colors">Locations de Vacances</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="font-semibold mb-4 text-red-500">Informations de Contact</h4>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Say Allo Immo. Tous droits réservés. | Construit avec excellence et innovation.</p>
        </div>
      </div>
    </footer>
  );
