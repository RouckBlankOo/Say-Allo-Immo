      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button className="bg-red-600 hover:bg-red-700 text-white rounded-full px-6 shadow-md transition-all duration-200 text-sm font-medium hover:shadow-lg hover:-translate-y-0.5">
              Connexion
            </Button>
            <Button
              variant="outline"
